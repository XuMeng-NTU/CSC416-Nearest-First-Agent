...
import tileworld.agent.impl.MaxExplore_NearestFirst_AStartSearchTWAgent;
import tileworld.agent.impl.MaxExplore_NearestFirst_MaxExploreSearchTWAgent;
...
public class TWEnvironment extends SimState implements Steppable {
    ...
    public void start() {
        ...
        TWAgent agent1 = new MaxExplore_NearestFirst_MaxExploreSearchTWAgent(0, 0, this, Parameters.defaultFuelLevel);
        TWAgent agent2 = new MaxExplore_NearestFirst_MaxExploreSearchTWAgent(1, 1, this, Parameters.defaultFuelLevel);
