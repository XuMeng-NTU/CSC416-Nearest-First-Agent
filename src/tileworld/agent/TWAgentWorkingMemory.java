...
import tileworld.util.PrintUtil;
...
//expectedTTL = (int) ((TWObject) sensedObjectsGrid[x][y]).getTimeLeft(this.getSimulationTime());
    ...
    private boolean inBoundary(int x, int y){
        return x>=0 && y>=0 && x<me.getEnvironment().getxDimension() && y<me.getEnvironment().getyDimension();
    }
