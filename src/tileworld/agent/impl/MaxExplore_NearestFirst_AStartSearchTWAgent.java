 ...
 *
 */
public class MaxExplore_NearestFirst_AStartSearchTWAgent extends TWAgent{
    
    private AstarPathGenerator planner;
    private TWEntity target;
    
    public MaxExplore_NearestFirst_AStartSearchTWAgent(int xpos, int ypos, TWEnvironment env, double fuelLevel) {
        super(xpos,ypos,env,fuelLevel);
        
        planner = new AstarPathGenerator(this.getEnvironment(), this, this.getEnvironment().getxDimension()+this.getEnvironment().getyDimension());
    }
    ...
    protected TWThought think() {
        ...
        if(this.carriedTiles.isEmpty()){
            ...
            if(tile==null && hole==null){
                ...
                TWPath tilePath = planner.findPath(x, y, tile.getX(), tile.getY());
                TWPath holePath = planner.findPath(x, y, hole.getX(), hole.getY());
